...
pub fn main() anyerror!void {
    ...
    // create flush entity
    _ = try storage.createEntity(.{ .tag = Components.FlushTag{} });
...
pub fn renderLineSystem(query: *LinePosQuery, event_arg: *EventArg) void {
