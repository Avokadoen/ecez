...
while (living_iter.next()) |item| {
    // Item is the type submitted in the query. In this case it will 
    // have 'health' which is pointer to Component.Health
...
// The scheduler tracks all reads and writes done on the components in order to safetly do 
// this without race hazards.
